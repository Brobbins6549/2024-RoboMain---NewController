...
public:
    ...
    static LimelightBack& GetInstance() {
        static LimelightBack instance;
        return instance;
    }
    ...
    void Normal() {
        ...
        LimelightBack::GetInstance().setLime(true);       
    ...
    void April() {
        ...
        nt::NetworkTableInstance::GetDefault().GetTable("limelight-back")->PutNumber("pipeline", 3);
        LimelightBack::GetInstance().setLime(false);
    }
    void Items() {
        nt::NetworkTableInstance::GetDefault().GetTable("limelight-back")->PutNumber("pipeline", 4);
        LimelightBack::GetInstance().setLime(false);    
    }
...
private:
    ...
    LimelightBack() {
        table = nt::NetworkTableInstance::GetDefault().GetTable("limelight-back");
    }

    // Deleted copy and move constructors and assignments to enforce singleton pattern.
    LimelightBack(const LimelightBack&) = delete;
    LimelightBack& operator=(const LimelightBack&) = delete;
    LimelightBack(LimelightBack&&) = delete;
    LimelightBack& operator=(LimelightBack&&) = delete;
