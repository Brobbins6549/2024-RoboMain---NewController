...
class TimeDriveHold : public AutoStep {
    ...
    public:
        TimeDriveHold(const double x, const double y, const double timeToDrive, const bool hold, const bool jerk = false) : AutoStep("TimeDriveHold") {
        ...
        bool Execute() {
            ...
            if (delta < m_totalTimeToDrive) {
                ...
                SwerveTrain::GetInstance().Drive(m_x, m_y, 0, m_hold, true, speed * AUTO_EXECUTION_CAP);
                return false;
            }
            else {
