...
void SwerveTrain::GetDrivePosition() {

    frc::SmartDashboard::PutNumber("FR rotations", m_frontRight->GetDrivePosition());
    frc::SmartDashboard::PutNumber("FL rotations", m_frontLeft->GetDrivePosition());
    frc::SmartDashboard::PutNumber("BR rotations", m_rearRight->GetDrivePosition());
    frc::SmartDashboard::PutNumber("BL rotations", m_rearLeft->GetDrivePosition());
}
